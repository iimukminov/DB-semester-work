...
6) Попробовать семантический поиск. Примеры запросов:
    - как искать по формам ![img.png](img/img.png)
    - как улучшить очистку данных ![img_1.png](img/img_1.png)
    - сервер падает, потому что подключилось слишком много пользователей, как спастись? ![img_2.png](img/img_2.png)
7) Перейти на http://localhost:6333/dashboard#/collections/demo_collection/graph и запустить пример кода справа с LIMIT 15 и посмотреть как выглядят данные ![img_3.png](img/img_3.png)